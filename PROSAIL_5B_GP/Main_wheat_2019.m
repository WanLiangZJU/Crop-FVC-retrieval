...
R=xlsread('F:\xxx...xxx\Dataset\wheat dataset.xlsx','spectra');
R1=R(p,1:25);
rmes=R1';
%% determinte the LAD
...
P0=[N Cab Car Cbrown Cw  Cm   LAI tts tto psi psoil hspot LAD];
%% the smallest values of model parameters
LB=[1  10   2  0   0.01  0.001  1  10  0   140 0 hspot LAD]; 
%% the largest values of model parameters
UB=[3  60    8  0  0.05  0.009    9  30 0  170 0 hspot LAD];
