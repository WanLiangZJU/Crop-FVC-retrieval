...
R=xlsread('D:\xxx...xxx\Dataset\oilseed rape 2019 dataset.xlsx','spectra');
R1=R(p,1:25);
rmes=R1';
%% determinte the LAD
...
LB=[1  10   2  0   0.01  0.002  0  30  0   90 0 hspot LAD]; 
%% the largest values of model parameters
UB=[3  60    8  0  0.05  0.009    6  90 0  280 1 hspot LAD];
